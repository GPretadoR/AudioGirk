...
//  NSLog(@"webviewSize: %f * %f, fontPercentSize: %d", theWindowSize.size.width, theWindowSize.size.height,theFontPercentSize);
    ...
    NSURLRequest* urlRequest = [NSURLRequest requestWithURL:[NSURL fileURLWithPath:spinePath]cachePolicy:NSURLRequestReloadIgnoringLocalCacheData timeoutInterval:60.0];
...
//    NSLog(@"webview width:%f",webView.bounds.size.width);
